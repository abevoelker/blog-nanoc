...
### ABL: Poor Unix batch mode error handling. <span class="label notice">Added 2010-08-31</span>
...
### OOABL: No support for interface inheritance (subinterfaces).
...
interface, which can lead to better design (e.g. see how `java.util.Collection`
extends `java.lang.Iterable`).  ABL does not allow the latter
functionality; you cannot have an interface extend another interface.

For an example, try to compile this code:
...
You will get a Progress error:

<div class="alert-message block-message error">
  <code>Inheritance is not supported for interfaces. (13046)</code>
</div>
which will stop you dead in your tracks.

Supposedly, this feature is planned for OpenEdge 11.  So, like usual, you need
to pay more money to upgrade when your application evolves enough to require 
